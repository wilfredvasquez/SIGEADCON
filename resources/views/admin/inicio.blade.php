...
@section('contenido')
	<div class="row">
		<div class="col mx-auto">
			<h4><center>Lista de Contadores que esperan por aprobación</center></h4>
			<br>
            ...
            <table class="table table-striped table-sm">
					...
					<tr>
					   ...
					   <td class="text-center" style="vertical-align:middle;">
						  <a href="{{route('admin.mostrarcontador',['contador'=>$contador])}}" class="btn btn-link">
							...
							<a href="{{route('admin.cambiarestatuscontador',['contador'=>$contador, 'url'=>'admin.inicio'])}}" class="btn btn-link">
              ...
              @else
				   ...
				   <tr>
						<td colspan="6">
							<br>
							<p><center>No hay resultados de búsqueda o no hay contadores nuevos registrados</center></p>
						</td>
		    		</tr>		
				  @endif
              </tbody>
