	...
	<div class="documento mx-auto">
		...
		<div class="row">
			...
			<div class="col">
				<!-- Fecha del Documento-->
				<p class="text-right">
					<input class="campo-rellernar text-right" size="40" type="text" name="fecha_cart" id="fecha_cart" placeholder="Lugar y Fecha">
				</p>
				...
				<p class="text-justify">
					<input class="campo-rellernar" size="80" type="text" name="direccion" id="direccion" placeholder="Dirección">
				</p>
				<br>
				...
				<input class="campo-rellernar text-center total_ingresos_text" size="10" name="ingresos_cart" type="text" placeholder="Total" readonly>
				por el periodo comprendido entre el 
				<!-- Periodo-->
				<input class="campo-rellernar text-center" size="40" type="text" name="periodo_cart" id="periodo_cart" placeholder="Periodo">, 
				...
				<input class="campo-rellernar text-center total_ingresos_text" size="10" type="text" placeholder="Total" readonly> 
				...
				<input class="campo-rellernar" size="83" type="text" name="soporte" placeholder="Ej: Depósitos bancarios realizados en mi cuenta corriente en (Banco).">
				</textarea>
				</p><br>
