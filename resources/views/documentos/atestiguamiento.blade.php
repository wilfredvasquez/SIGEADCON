	...
	<div class="documento mx-auto">
		...
		<div class="row">
			<div class="col">
				...
				<input class="campo-rellernar" size="40" type="text" name="institucion" id="institucion" placeholder="Institucion">
				...
				periodo entre el 
					<!--Período 1-->
				<input class="campo-rellernar text-center" size="40" type="text" name="periodo_1" id="periodo_1" placeholder="Periodo">, 
				del ciudadano  
				...
				<input class="campo-rellernar" size="83" type="text" name="actividad" id="actividad" placeholder="Actividad del Cliente">
				</p><br>
				<p class="text-justify">
				...
				correspondiente al periodo comprendido entre el 
					<!-- Período 2 -->
				<input class="campo-rellernar text-center" size="40" type="text" name="periodo_2" id="periodo_2" placeholder="Periodo">. 
				...
				<input class="campo-rellernar" size="45" type="text" name="motivo" id="motivo" placeholder="Motivo">.  
				</p><br>
				...
				<p class="text-justify">
					<!-- Fecha del Documento -->
				<input class="campo-rellernar" size="40" type="text" name="fecha_ates" id="fecha_ates" placeholder="Lugar y Fecha">
				</p>
			</div>
		</div>
	</div>
